...
def bootstrap_agent_registry() -> None:
    ...
    for executor in (LabourEmploymentAgentExecutor, AgricultureRuralAgentExecutor, ExternalSectorAgentExecutor):
        instance = executor()
        agent_registry.register(executor.get_agent_card(), instance)
